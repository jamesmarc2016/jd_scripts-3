...
async function invite() {
  let lkt = new Date().getTime()
  let lks = $.md5('' + 'RtKLB8euDo7KwsO0' + lkt).toString()
  const url = `https://draw.jdfcloud.com/common/api/bean/activity/invite?openId=&activityId=${$.activityId}&userSource=mp&formId=123&jdChannelId=&fp=&appId=wxccb5c536b0ecd1bf&invokeKey=RtKLB8euDo7KwsO0`;
  const method = `POST`;
  const headers = {
    'content-type' : `application/json`,
    'Connection' : `keep-alive`,
